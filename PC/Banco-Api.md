...
| Google AI (Gemini) | `GOOGLE_API_KEY` | `AIzaSy...` | `generative-language:generateContent`, `generative-language:embedContent` | 10/11/2025 |
| Google AI (Gemini) extra | `GOOGLE_API_KEY_ADDITIONAL_1` | `AIzaSy...` | Backup com escopo idêntico | 10/11/2025 |
| Google AI (Gemini) extra | `GOOGLE_API_KEY_ADDITIONAL_2` | `AIzaSy...` | Failover mobile | 10/11/2025 |
| OpenRouter | `OPENROUTER_API_KEY` | `sk-or-v1-...` | Acesso a modelos GPT/Claude/Qwen | 14/11/2025 |
| **GitHub** | `GITHUB_PERSONAL_ACCESS_TOKEN` | `github_pat_...` | `repo`, `workflow`, `admin:repo_hook`, `delete_repo`, `user:email` | **16/11/2025 22:48 BRT (capturado agora)** |
| Context7 | `CONTEXT7_API_KEY` | `ctx7sk-...` | Docs sempre atualizadas para agentes | 09/11/2025 |
| Tavily | `TAVILY_API_KEY` | `tvly-dev-...` | Busca web avançada | 05/11/2025 |
| Cartesia | `CARTESIA_API_KEY` | `sk_car_...` | Síntese de voz | 03/11/2025 |
...
GOOGLE_API_KEY_ADDITIONAL_1=AIzaSy...
GOOGLE_API_KEY_ADDITIONAL_2=AIzaSy...
```
