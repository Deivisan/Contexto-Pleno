...
> ⚠️ **Nota (2025-12-16):** este ROADMAP é **histórico** do ciclo “Docker-first”.
> O padrão atual do repositório passou a ser **npm/npx-first** (portável) e Docker ficou como **legado/em pausa**.
>
> - Status/decisão: `../Shared/STATUS-2025-12-16.md`
> - Guia + templates (universal): `../mcp/README.md`
